...
from vivarium_gates_child_iv_iron_temp.constants import data_keys, metadata
from vivarium_gates_child_iv_iron_temp.utilities import sanitize_location, delete_if_exists, len_longest_location
from vivarium_gates_child_iv_iron_temp.tools.app_logging import add_logging_sink, decode_status
...
def build_single_location_artifact(path: Union[str, Path], location: str, log_to_file: bool = False):
    ...
    from vivarium_gates_child_iv_iron_temp.data import builder
